...
class FERPlusParameters():
    ...
    '''
    def __init__(self, target_size, width, height, training_mode = "probability", determinisitc = False, shuffle = True):
...
class FERPlusReader(object):
    ...
    def create(cls, base_folder, sub_folders, label_file_name, parameters):
        '''
        Factory function that create an instance of FERPlusReader and load the data from disk.
        '''
